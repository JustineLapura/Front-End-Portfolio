        ...
        <div className="">
          ...
          >
            <button
              ...
              className="py-1 px-5 rounded-full border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-orange-50 border-2 m-1"
            >
              All
            </button>
            <button
        ...
        {foods.map((food) => (
          ...
          >
            ...
            <div className="flex justify-end gap-2 items-center p-2">
              <button
                className={`${mode === "dark" ? "text-white border-2 border-white" : "border-2 border-black" } px-1 py-1 flex items-center text-sm rounded-lg hover:bg-orange-600 hover:text-white hover:border-orange-600`}
                onClick={() => newAddToCart(food.id)}
              >
                +<BsFillCartFill /> {orders[food.id] > 0 && <>({orders[food.id]})</>}
              </button>
              <button className="text-sm hover:text-xs px-5 py-1 rounded-full bg-orange-600 text-white border-orange-600 duration-300 hover:bg-white hover:text-orange-600 hover:border-orange-600 hover:border-2 hover:font-bold">Buy now</button>
            </div>
          </div>
        ))}
      </div>
