  ...
  return (
    <div className="w-full min-h-screen pb-10">
      ...
      <div className="relative grid lg:grid-cols-2 gap-4">
        <Link className="fixed left-4 top-[100px]" href="/property/demo-1" >
          <button className="bg-orange-600 text-white border-none text-sm py-1 px-5 rounded-full">Back</button>
        </Link>
              ...
              >
                <div className="flex gap-4">
                  ...
                  <div className="flex flex-col gap-4 sm:text-xl md:text-2xl">
                    ...
                    <div className="flex">
                      <button
                        className={`${mode === "dark" ? "border-white border " : "border border-black"} p-0 px-1 rounded-none flex justify-center items-center hover:bg-black hover:text-white`}
      ...
      {totalAmount > 0 ? (
        <div className="flex flex-col items-center gap-8 py-8">
          ...
          <div className="flex justify-center gap-4">
            <Link href="/property/demo-1">
              <button className="py-1 px-5 border-2 rounded-full bg-black text-white border-white">Continue Shopping</button>
            </Link>
            <button className={`${mode === "dark" ? "bg-white text-black": ""} py-1 px-5 border-2 border-black rounded-full hover:bg-black hover:border-white hover:text-white duration-300`} >Checkout</button>
          </div>
        </div>
      ) : (
